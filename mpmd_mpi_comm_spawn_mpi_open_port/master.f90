...
program master
    ...
    call MPI_recv(portname, MPI_MAX_PORT_NAME, MPI_CHARACTER, 0, 2, child_comm(1), MPI_STATUS_IGNORE)
    ...
    call MPI_send(portname, MPI_MAX_PORT_NAME, MPI_CHARACTER, 0, 2, child_comm(2))
